...
public class ModelColour : MonoBehaviour {
    ...
    public void setModelColour(Color colour) {
        ...
        */
        ...
        modelEyesInner = GameObject.Find("/Male_Patient/Eyes_Inner");
        modelEyesOuter = GameObject.Find("/Male_Patient/Eyes_Outer");
        modelFeet = GameObject.Find("/Male_Patient/M_Base_2_0_Feet");
        modelHands = GameObject.Find("/Male_Patient/M_Base_2_0_Hands");
        modelHead = GameObject.Find("/Male_Patient/M_Base_2_0_Head");
        modelLegs = GameObject.Find("/Male_Patient/M_Base_2_0_Legs");
        modelTorso = GameObject.Find("/Male_Patient/M_Base_2_0_Torso");
        modelUnderwear = GameObject.Find("/Male_Patient/M_Base_2_0_Underwear");
        modelHair = GameObject.Find("/Male_Patient/M_Hair_06");
        modelHairband = GameObject.Find("/Male_Patient/M_Hair_06_Band");
