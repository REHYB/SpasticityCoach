...
public class JointOrientationClient : MonoBehaviour
{
    ...
    Vector3 body_rot;
    Vector3 rightShoulder_rot;
    Vector3 leftShoulder_rot;
    Quaternion rightElbow_rot;
    ...
    void Update ()
    {
        ...
        rightElbow_rot = _antiYaw * antiRoll * Quaternion.LookRotation(myo.transform.forward);
        ...
        if (thalmicMyo.xDirection == Thalmic.Myo.XDirection.TowardWrist) {
            ...
            rightElbow_rot = new Quaternion(transform.localRotation.x,
                                                -transform.localRotation.y,
                                                transform.localRotation.z,
                                                -transform.localRotation.w);
        }
    ...
    void OnAnimatorIK(int layerIndex) {
        ...
        anim.SetBoneLocalRotation(HumanBodyBones.RightLowerArm, rightElbow_rot);
