...
public class StoreEMG : MonoBehaviour
{
    ...
    public void storeData(int[] emg) {
        ...
        //UnityEngine.Debug.Log("Size of raw emg array (StoreEMG): " + emg.Length);

        // Somehow this helps with the EMG pod 08 issue
        ...
        if (counter > 1)
        {
            ...
            //UnityEngine.Debug.Log("emg data - POD 1: " + emg[0]);
            //UnityEngine.Debug.Log("emg data - POD 8: " + emg[7]);
