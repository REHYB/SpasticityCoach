...
[ExecuteInEditMode()]
public class RadialProgressMarker : MonoBehaviour
{
    public static Image marker;
    public static bool showMarker;
    public static float clientElbow_rot;
    ...
    void Update()
    {
        ...
        if (showMarker == true)
        {
            ...
            clientElbow_rot = 270 - ClientRoutine_Sitting.elbowMyo.z * 180 ;

            GetComponent<Transform>().localRotation = Quaternion.Euler(0, 0, clientElbow_rot);
