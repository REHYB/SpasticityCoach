...
namespace AwesomeCharts {
    ...
    public class LineChart : AxisBaseChart<LineData> {
        ...
        // Line Added after comparing with PieChart.cs
        //public delegate void EntryClickDelegate(int index, LineEntry entry);
        ...
        // Lines Added after comparing with PieChart.cs
        /*
        private List<EntryClickDelegate> clickDelegates = new List<EntryClickDelegate>();
        private List<LineEntry> selectedEntries = new List<LineEntry>();
        */
