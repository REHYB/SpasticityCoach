...
public class FlexSleeve_manager : MonoBehaviour {

	// Use this for initialization
	BluetoothHelper bluetoothHelper;   // Controls communication between device and Aduino 
    string deviceName;
	...
	void Start () {
		deviceName = "FlexSleeve"; //bluetooth should be turned ON;
		try
		{	
