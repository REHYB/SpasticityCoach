...
BLEService motorService("78323a84-b5a4-4231-898f-6f422acc6235");//ebbb19a6-c943-44f9-aee0-e180300007f0"); //custom 120-bit UUID custom service

//motor characteristic
BLEIntCharacteristic motorReading("00211321-dc03-4f55-82b6-14a630bd8e2d", BLERead | BLENotify | BLEWrite);

//motor properties
BLEIntCharacteristic motorExtendChar("809ba7a9-13ad-4446-a005-bdc12ca93c76", BLERead | BLENotify | BLEWrite);
BLEFloatCharacteristic motorContractChar("2fad8a3f-e1a1-47cd-982b-24e13fbe9342", BLERead | BLENotify | BLEWrite);
BLEFloatCharacteristic gxChar("ebbb19a6-c943-44f9-aee0-e180300007ff", BLERead | BLENotify | BLEWrite);
